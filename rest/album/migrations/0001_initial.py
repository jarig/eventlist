...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'album_album', (
            ...
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 12, 22, 0, 0), auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'album', ['Album'])

        # Adding model 'Image'
        db.create_table(u'album_image', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('album', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['album.Album'])),
            ('url', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('caption', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('added', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 12, 22, 0, 0), auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'album', ['Image'])
    ...
    models = {
        ...
        u'album.album': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 22, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'default': "''"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'album.image': {
            'Meta': {'object_name': 'Image'},
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 22, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
