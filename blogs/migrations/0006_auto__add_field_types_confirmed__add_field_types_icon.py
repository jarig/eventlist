...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Types.confirmed'
        db.add_column('blogs_types', 'confirmed', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Types.icon'
        db.add_column('blogs_types', 'icon', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Types.confirmed'
        db.delete_column('blogs_types', 'confirmed')

        # Deleting field 'Types.icon'
        db.delete_column('blogs_types', 'icon')
