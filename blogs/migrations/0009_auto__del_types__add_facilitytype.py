...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('blogs_types')

        # Adding model 'FacilityType'
        db.create_table('blogs_facilitytype', (
        ...
        db.send_create_signal('blogs', ['FacilityType'])

        # Removing M2M table for field types on 'Blog'
        db.delete_table('blogs_blog_types')

        # Adding M2M table for field facilities on 'Blog'
        db.create_table('blogs_blog_facilities', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('blog', models.ForeignKey(orm['blogs.blog'], null=False)),
            ('facilitytype', models.ForeignKey(orm['blogs.facilitytype'], null=False))
        ))
        db.create_unique('blogs_blog_facilities', ['blog_id', 'facilitytype_id'])
    
    
    def backwards(self, orm):
        
        # Adding model 'Types'
        db.create_table('blogs_types', (
            ('confirmed', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('icon', self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal('blogs', ['Types'])

        # Deleting model 'FacilityType'
        db.delete_table('blogs_facilitytype')

        # Adding M2M table for field types on 'Blog'
        db.create_table('blogs_blog_types', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('blog', models.ForeignKey(orm['blogs.blog'], null=False)),
            ('types', models.ForeignKey(orm['blogs.types'], null=False))
        ))
        db.create_unique('blogs_blog_types', ['blog_id', 'types_id'])

        # Removing M2M table for field facilities on 'Blog'
        db.delete_table('blogs_blog_facilities')
