...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BlogAccess.access'
        db.alter_column('blogs_blogaccess', 'access', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
    
    
    def backwards(self, orm):
        
        # Changing field 'BlogAccess.access'
        db.alter_column('blogs_blogaccess', 'access', self.gf('django.db.models.fields.CharField')(max_length=2))
