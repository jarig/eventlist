...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Blog.logo'
        db.add_column('blogs_blog', 'logo', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100), keep_default=False)

        # Adding field 'Blog.name'
        db.add_column('blogs_blog', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=64), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Blog.logo'
        db.delete_column('blogs_blog', 'logo')

        # Deleting field 'Blog.name'
        db.delete_column('blogs_blog', 'name')
