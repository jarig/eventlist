...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BlogStyle.default'
        db.add_column('blogs_blogstyle', 'default', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'BlogStyle.default'
        db.delete_column('blogs_blogstyle', 'default')
